...
fields = ['m_MailerIp', 'm_LogDate', 'end_time', 'rcpt', 'window_count', 'message', 'snds_filter', 'complaint',\
    'trap_start', 'trap_finish', 'snds_count',  'helo', 'mail_from', 'comments']
...
dfall.drop(columns = ['rcpt', 'message', 'complaint', 'helo', 'mail_from', 'comments'], inplace=True)
dfall['complaint_rate'] = 0.001
print(dfall.shape)
print(dfall.dtypes)
dfall.to_csv(directory + 'sndsjan2118.csv', index=False)